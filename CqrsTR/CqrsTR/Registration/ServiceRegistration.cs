...
namespace CqrsTR.Registration
{
    public static class ServiceRegistration
    {
        public static void AddCqrsTRClasses(IServiceCollection services, CqrsServiceConfiguration configuration) 
        {
        ...
        public static void AddRequiredServices(IServiceCollection services, CqrsServiceConfiguration serviceConfiguration)
        {
